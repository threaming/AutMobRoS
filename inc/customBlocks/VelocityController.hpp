...
class VelocityController : public Block
{
public:
    /**
     ...
     */
    VelocityController(double om0, double D, double M, T eLimit)
        : qd(this),
          KP(2.0 * D * om0),
          KI(om0 * om0),
          M(M)
     ...
     * @param eLimit integrator limit
     */
    VelocityController(double fTask, double D, double s, double M, T eLimit)
        : qd(this),
          KP(fTask / s),
